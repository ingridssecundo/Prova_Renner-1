Projeto: Automação API de site de compras
...
Cenários de Teste: Cenário 1: Cadastrar Usuário Cenário 2: Consultar Usuário Cenário 3: Consultar Lista de Usuário Cenário 4: Alterar Usuário
